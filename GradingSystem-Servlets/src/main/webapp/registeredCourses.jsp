<%@ page import="com.example.elearning.Model.StudentCourse" %>
<%@ page import="java.util.List" %>
<%@ page import="com.example.elearning.Service.CourseService" %>
<%
    List<StudentCourse> studentCourses = (List<StudentCourse>) request.getAttribute("registeredCourses");
                ...
                <div class="card border bg-transparent rounded-3">
                    ...
                    <div class="card-header bg-transparent border-bottom p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="mb-2 mb-sm-0">Register courses<span
                                    class="badge bg-primary bg-opacity-10 text-primary">6</span></h5>
                        </div>
                    </div>
                    <!-- Card header END -->
                            ...
                            <table class="table align-middle p-4 mb-0 table-hover table-shrink">
                                ...
                                <thead class="table-dark">
                                    <tr>
                                        ...
                                        <th scope="col" class="border-0 rounded-end text-center">Class Statics</th>
                                    </tr>
                                </thead>
                                ...
                                <% for (StudentCourse item : studentCourses) { %>
                                    ...
                                    <tr>
                                        <!-- Table data -->
                                        <td>
                                            <h6 class="table-title mt-2 mt-md-0 mb-0"><%=courseService.getCourse(item.getCourseId()).getName()%></h6>
                                        </td>
                                        <!-- Table data -->
                                        <td class="text-center">
                                            <form action="/course-marks" method="get">
                                                <input type="hidden" name="courseId" value="<%=item.getCourseId()%>">
                                            <button type="submit" data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap"
                                                class="btn btn-light btn-round mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="View"><i
